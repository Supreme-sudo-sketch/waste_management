...
<table>
    <tr><th>User Type</th><th>Payment For</th><th>Amount</th><th>Payment Method</th><th>Transaction ID</th><th>Status</th><th>Action</th></tr>
    <?php while ($row = $payments->fetch_assoc()): ?>
        <tr>
            <td><?php echo htmlspecialchars($row['user_type']); ?></td>
            <td>
                <?php 
                    // Ensure it displays "Waste Pickup", "Booking", or "Both"
                    echo htmlspecialchars($row['payment_for']);
                ?>
            </td>
